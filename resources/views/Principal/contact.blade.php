...
@endif
    ...
    <div class="input-box">
        <textarea class="form-input" placeholder="Enter the message" name="message" required></textarea>
    </div>
    <div class="contact-submit">
      ...
      <div class="col-lg-5">
        <div class="about-crypton">
          <h2 class="textwhitecolor contact-head">About <span class="textbluecolor">SeaFood4Africa</span></h2>
          <p> <span class="textbluecolor">Cette plateforme B2B</span> est conçue pour faciliter les connexions entre les entreprises africaines du secteur de la pêche et de l'aquaculture. Elle permet de développer des partenariats stratégiques, d'explorer de nouvelles opportunités commerciales, et de renforcer le réseau professionnel à l’échelle continentale.</p> 
            ...
            <ul>
              ...
              <li>
                <a href="#" class="textwhitecolor">
                 ...
                 Bd Anoual 09, Rue Abou Maachar, Appt 5, 1er étage Quartier, Casablanca
                </a>
              </li>
            </ul>
          </div>
