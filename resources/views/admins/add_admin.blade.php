                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('dashboard.add-admin') }}" method="POST">
                                            @csrf
                                            <div class="form-group mb-3 row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">Name:</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" placeholder="Enter Title" name="name" required >
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 row">
                                            ...
                                            <div class="form-group mb-3 row">
                                                <label for="example-email-input" class="col-md-2 col-form-label">Confirm Password:</label>
                                                <div class="col-md-10">
